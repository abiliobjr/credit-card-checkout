    ...
    return (
        <form action="#">
            <div className="material-form-field">
                <input type="text" required name="text" id="field-text" onChange={props.nameInputChange} value={cardNumber}/>
                <label className="material-form-field-label" for="field-text" >Número do cartão</label>
            </div>
            <div className="material-form-field">
                <input type="text" required name="text" id="field-text" value={name}/>
            ...
            <div className="flex-container space-between">
                <div className="material-form-field half">
                    <input type="text" required name="text" id="field-text"  value={validity} />
                    <label className="material-form-field-label" for="field-text">Validade</label>
                </div>
                <div className="material-form-field half">
                    <input type="text" required name="text" id="field-text" value={cvv} />
